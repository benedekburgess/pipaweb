			...
			<table>
				...
				while($row = mysqli_fetch_assoc($query)){
					...
					<tr>
						...
						<td><h3><?php if($current_user_admin==2){ ?><a href="/chgadmin/<?php echo $username; ?>"><?php } ?><img width="24" src="<?php if($admin==true){ echo "/img/pipa.png"; }else{ echo "/img/x.png"; }?>"><?php if($current_user_admin==2){ ?></a><?php } ?></h3></td>
